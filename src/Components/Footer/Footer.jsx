...
const socialLinks =[
    ...
    {
        path:"https://github.com/AlbertSimonA",
        icon:<AiFillGithub className='group-hover:text-white w-4 h-5'/>
    }
    ,{
        path:"https://www.youtube.com/channel/UCZJq04aIdaCFMMS15ti8f2g",
   ...
   <footer className='pb-16 pt-10'>
    <div className='container'>
        <div className="flex justify-between flex-col md:flex-row flex-wrap gap-[30px]">
            <div>
               <img src={logo} alt="" />
               <p className='text-[16px] leading-7 font-[400] text-textColor mt-4'>Copyright @ {year} developed by Albert Simon</p>
            ...
            <div>
               <h2 className='text-[20px] leading-[30px] font-[700] mb-6 text-headingColor' >Wants to</h2> 
               <ul>
