    ...
    <div className='p-3 lg:p-5'>
        ...
        <div className='mt-[18px] lg:mt-5 flex items-center justify-between'>
            <div>
                ...
                <p className='text-[24px] leading-6 font-[400] text-textColor'>At {hospital}</p>
         </div>
         <Link to="/doctors" className='w-[44px] rounded-full border border-solid border-[#181A1E]  flex items-center justify-center group hover:bg-primaryColor hover:border-none
         '>
