...
const Home = () => {
  return (
        ...
        <div className='flex flex-col lg:flex-row gap-[90px] items-center justify-between'>
              ...
              <div>
                <div className='lg:w-[570px]'>
                  <h1 className='text-[36px] md:leading-[70px] md:text-[60px] font-[800] leading-[46px] text-headingColor'>We help patients live a healthy, longer life.</h1>
                <p className='text_para'>Lorem ipsum dolor sit amet consectetur adipisicing elit. 
                  Beatae quam nobis est culpa veniam odit at aperiam ipsum 
                  pariatur, repellendus quis dicta molestiae harum, quo assumenda 
                  cumque maiores. Labore, mollitia?</p>
                  <button className='btn'>For Appoinment</button>
                </div>
    ...
    <section>
      <div className="container">
        <div className='lf:w-[470px] mx-auto'>
     ...
     <section>
      <div className="container">
        <div className='xl:w-[470px] mx-auto'>
          ...
          <p className='text_para text-center'>World class care for everyone. Our health system offer unmatched.
            expert health care.
          </p>
        </div>
        <ServiceList/>
            ...
            <div className='w-[150px] lg:w-[248px] bg-white absolute bottom-[50px] left-0 md:bottom-[100px] md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px]'>
              <div className='flex items-center justify-between'>
                <div className='flex items-center gap-[6px] lg:gap-3'>
                  <p className='text-[10px] leading-[20px] lg:text-[14px] lg:leading-5 text-headingColor font-[600]'>Tue, 24</p>
                  <p className='text-[10px] leading-[20px] lg:text-[14px] lg:leading-5 text-textColor font-[400]'>10:00 AM</p>
              ...
              <div className='flex items-center gap-[6px] lg:gap-[10px] mt-2 lg:mt-[18px]'>
                ...
                <h4 className='text-[10px] leading-3 lg:text-[16px] lg:leading-[22px] font-[700] text-headingColor'>Albert Simon</h4>
              </div>
