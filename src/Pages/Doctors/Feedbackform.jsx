  ...
  return (
    ...
    <div>
        ...
        <div>
            {[...Array(5).keys()].map((_,index)=>{
                index+=1
                return <button key={index} type="button" className={`${index < 
                    ((rating && hover) || hover) ? 'text-yellowColor': 'text-gray-400'}
    ...
    <div className='mt-[30px]'>
        <h3 className='text-headingColor text-[16px] leading-6 font-semibold mb-4 mt-0'>
            ...
            py-3 rounded-md'  rows="5" placeholder='Writer your message' onChange={e=> setReviewText(e.target.value)}></textarea>
    </div>
